...
packages <- c("caTools","ggplot2","scales","readxl","class","e1071","rpart",
              "randomForest","cluster")

# Use of the above libraries
#caTools- Splitting the dataset into train and test set
#ggplot2- Visualizing Results
#scales- continous scale on axis
#readxl- Reading execl data
#class- Fitting KNN Algorithm
#e1071- Fitting Support vector machine, Naive Bayes
#rpart- Fitting Decision Tree Classifier
#randomForest- Fitting Random Forest 
#cluster- Visualizing kmeans clusters and HC
